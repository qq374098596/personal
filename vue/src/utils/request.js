...
/* 普通请求 */
export const request = (url, params, config = {'Content-Type': 'application/x-www-form-urlencoded', 'Access-Token': '84c6635800b14e0eba4f7ece65e095a1'}, auto_error_res = true, auto_error_data = true) => {
