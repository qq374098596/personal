...
export default {
  ...
  // created:function(){
  //   this.$axios.post('/login/editpassword',{}).then(data=>{
  ...
  methods: {
    handleSubmit (ev) {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          this.$axios.post('api/login/editpassword',
            {oldPass:this.ruleForm.oldPass,newPass:this.ruleForm.newPass,checkPass:this.ruleForm.checkPass}
          ).then(data=>{
            console.log(data);
          })
        } else {
