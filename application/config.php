...
define('RESOURCEPATH', ROOTPATH.'public'.DS.'static'.DS); //文件路径
define('CDNRESOURCE', ROOTURL.'/static/');//路径url
define('CSS_VERSION', '0.0.1');
define('JS_VERSION', '0.0.1');
